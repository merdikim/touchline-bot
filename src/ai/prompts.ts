...
export function buildIntentPrompt(context: IntentContext): string {
  return [
    ...
    "- smalltalk: friendly/social message, or any off-topic/general-knowledge question, that does not need app state. Answer it in smalltalkResponse.",
    "- unclear: the message asks Touchline for something but you cannot tell what. Never use unclear for a question you could simply answer or reply to.",
    "",
    "Rules:",
    ...
    "- Off-topic questions (capitals, trivia, weather, general knowledge) are smalltalk: answer them directly in one short sentence.",
